...
private const val TAG = "ReplayLocalLikeSwingFeedbackPagingSource_싸피"
class ReplayLocalLikeSwingFeedbackPagingSource @Inject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, SwingFeedback> {
        ...
        return try {
            ...
            val response = swingFeedbackLocalDataSource.getLikeSwingFeedbackList(userID, params.loadSize, currentPage)
            LoadResult.Page(
                data = response,
